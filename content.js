...
function sendRequest(search) {
    ...
    function requestHandler(response) {
        if (request.status === 200)
            chrome.runtime.sendMessage({ data: response.target.response })
    }
    request.open("GET", URL, false);
    request.setRequestHeader("x-rapidapi-key", "73ed7cc5b0msh81ba37d7896b5b7p193b56jsn76e4d2251350");
    request.setRequestHeader("x-rapidapi-host", "imdb8.p.rapidapi.com");
    request.send();
}
...
const data = {
    "@meta": {
        "operation": "Search",
        "requestId": "c27ef782-9743-44bc-8ddc-f3d49766a0b6",
        "serviceTimeMs": 69.087006
    },
    ...
    "results": [{
        ...
        },
        {
            ...
            "image": {
                "height": 3504,
                "id": "/title/tt13951636/images/rm3336619777",
                "url": "https://m.media-amazon.com/images/M/MV5BNjI0MjZiMDItYmFiNi00YTk5LThjYTYtY2U5M2FmY2Y1YzlhXkEyXkFqcGdeQXVyNTUyMzEyNjk@._V1_.jpg",
                "width": 2479
            },
            ...
            "principals": [{
                    "id": "/name/nm12279305/",
                    "legacyNameText": "Allocco, Alessandro",
                    "name": "Alessandro Allocco",
                    "category": "self",
                    "characters": [
                        "Self"
                    ],
                ...
                },
                {
                    "disambiguation": "II",
                    "id": "/name/nm12279307/",
                    "legacyNameText": "Bortolotti, Fabio (II)",
                    "name": "Fabio Bortolotti",
                    "category": "self",
                    "characters": [
                        "Self"
                    ],
        ...
        },
        {
            ...
            "image": {
                "height": 2962,
                "id": "/title/tt17200376/images/rm1086775553",
                "url": "https://m.media-amazon.com/images/M/MV5BYTdiZDg2NmMtNGQzMi00OTY4LWFmMDktODRmZmNkMDc2YWNiXkEyXkFqcGdeQXVyNDg3OTI2Mw@@._V1_.jpg",
                "width": 2000
            },
